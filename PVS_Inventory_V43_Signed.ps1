...
.PARAMETER To
	...
	If SmtpServer is used, this is a required parameter.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1
...
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -PDF 
	...
	LocalHost for AdminAddress.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -Hardware 
	...
	Administrator for the User Name.
.EXAMPLE
	PS C:\PSScript .\PVS_Inventory_V43.ps1 -CompanyName "Carl Webster Consulting" 
...
.EXAMPLE
	PS C:\PSScript .\PVS_Inventory_V43.ps1 -CN "Carl Webster Consulting" -CP "Mod" 
...
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -StartDate "01/01/2022" -EndDate "01/31/2022" 
...
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -AdminAddress PVS1 -Folder 
...
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -SmtpServer mail.domain.tld -From 
...
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -SmtpServer mailrelay.domain.tld -From 
	...
	***GMAIL/G SUITE SMTP RELAY***
	...
	account.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -SmtpServer 
	...
	***OFFICE 365 Example***
	...
	from SomeEmailAddress@labaddomain.com, sending to ITGroupDL@labaddomain.com.

	The script uses the default SMTP port 25 and SSL.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -SmtpServer smtp.office365.com -SmtpPort 587 
	...
	user to enter valid credentials.
.EXAMPLE
	PS C:\PSScript > .\PVS_Inventory_V43.ps1 -SmtpServer smtp.gmail.com -SmtpPort 587 
	-UseSSL -From Webster@CarlWebster.com -To ITGroup@CarlWebster.com	
	...
	*** NOTE ***
	...
	webster@gmail.com, sending to ITGroup@carlwebster.com.
	...
	ForEach($Store in $Stores)
	{
		...
		If($Null -ne $Servers)
		{
			ForEach($Server in $Servers)
			{
				...
				If($Null -ne $ServerStore -and $ServerStore.storeName -eq $Store.StoreName)
				{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUgi2XhZpl+gKmvyGVyIVDWGqz
# MEiggiEmMIIFkDCCA3igAwIBAgIQBZsbV56OITLiOQe9p3d1XDANBgkqhkiG9w0B
...
# AKBAMBkGCSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMCMGCSqGSIb3DQEJBDEWBBTI
# 8d2EJOW81Zyk2soSEN7rpXP6rzANBgkqhkiG9w0BAQEFAASCAgA3g+qF+pTUPmtU
# uIcGHkxWEqj4w+BLvskMqqhFlVHC+oj649o6zbv6ZPdaCZehGT3k1G+Psqo1gzXD
# QUHanvzBzO91LN6QsdNb8ptqUaJfAXRuskdN79C1zItt0YRyjqhxnjfDeiuk4NuJ
# dApyvgqOrReC6xq0iB80koMoMo97GOxdBlENLI+eY6GBX5YJpmGgZfBOHhVg0hRU
# VAvHPDCrnQpK8+n/qp8AWTHmR6qr/3jOkR9M5P6x2L+dY+Z0vM95zukxIkzz1Vs/
